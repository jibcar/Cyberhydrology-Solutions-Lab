## Modifications
## 2024-02-16
## Changed variable name from Trend-Result to MK_Combi_Trend
## filename pattern changed to "data_USGS_",file_name,"_",variable_selected,"_",start_year,"_",end_year,"_
## 2024-02-07
...
variable_selected<-"MK_Combi_Trend"#"Var_2Divide"#"KPSS_Result" #"Trend_Result" "MK_Combi_Trend"

start_year="1981" #1950, all
end_year="2021" #2014, all
...
## Plots Output Folder
folder_out<-paste0(folder_name_absolute,"\\Plots_IntermediateResults\\plots_boxplot_usgs_cesm2_v8\\")


df_list<-vector("list")
df_list[[1]]<-read.csv(paste0("data_USGS_",file_name,"_",variable_selected,"_",start_year,"_",end_year,"_all_df.csv"))
df_list[[2]]<-read.csv(paste0("data_CESM2_",file_name,"_",variable_selected,"_hist_df.csv"))%>%dplyr::select(HUC2,all_of(variable_selected),Percent,Type)
...
if(variable_selected=="MK_Combi_Trend"){
data_ensemble001<-read.csv(paste0("data_CESM2_",file_name,"_",variable_selected,"_hist_df.csv"))%>%
