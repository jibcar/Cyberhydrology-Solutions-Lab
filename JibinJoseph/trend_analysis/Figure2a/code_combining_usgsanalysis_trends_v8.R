...
setwd(paste0("C:\\Users\\",
             username,
             "\\Dropbox\\01_SharedFolder_Jibin\\Code_R\\code_regional_mk"))

## Plots Output Folder
folder_out<-paste0("C:\\Users\\",
                   username,
                   "\\Box\\01_SharedBox_Jibin\\Plots_IntermediateResults\\plots_regional_mk_v8_1950_2014\\")
...
#usgs_results_30<-read.csv(paste0("C:/Users/",username,"/Box/01_SharedBox_Jibin/Data_Intermediate/FFA_Analysis/FFA_EntireUS/z_Result10e/B_Results_Trend_Stationarity_",
#                                 start_year,
#                                 "_",
#                                 end_year,
#                                 "_missing_5percent_",
...
usgs_results_30<-read.csv(paste0("C:/Users/",username,"/Box/01_SharedBox_Jibin/Data_Intermediate/FFA_Analysis/FFA_EntireUS/z_Result10e/B_Results_Trend_Stationarity_alpha_",
                                 alpha_value,
                                 "_20230718-024208.txt"),  #v_5a
                                 #"_20230719-015114.txt"), #v_5b
                          sep='\t')
usgs_results_30<-read.csv(paste0("C:/Users/",username,"/Box/01_SharedBox_Jibin/Data_Intermediate/FFA_Analysis/FFA_EntireUS/z_Result10e/B_Results_Trend_Stationarity_1950_2014_missing_5percent_alpha_0.05_20240214-071742.txt"),  #v_5a
                          #"_20230719-015114.txt"), #v_5b
                          sep='\t')
...
write.csv(usgs_results_30_merged_result,
          paste0("C:/Users/",
                 username,
                 "/Box/01_SharedBox_Jibin/Data_Intermediate/merged_result_usgs_analysis.csv"), 
          row.names = FALSE)
...
for (sites_type in sites_type_list){
  ...
  if (max_senslope<max(huc2_sf_map_with_data$sen_slope)){
    max_senslope<-max(huc2_sf_map_with_data$sen_slope)
    
  }
  
  if (min_senslope>min(huc2_sf_map_with_data$sen_slope)){
    min_senslope<-min(huc2_sf_map_with_data$sen_slope)
    
  }
  
  if (max_norm_senslope<max(huc2_sf_map_with_data$norm_sen_slope_6000)){
    max_norm_senslope<-max(huc2_sf_map_with_data$norm_sen_slope_6000)
    
  }
  
  if (min_norm_senslope>min(huc2_sf_map_with_data$norm_sen_slope_6000)){
...
#usgs_huc2_states_1_norm_score_plot
ggsave(
  paste0(folder_out,"usgs_huc2_states_1_norm_score_plot","_site_type_",count_file,"_",sites_type,"_alpha_",alpha_value,".png"),
...
#usgs_huc2_states_2_sen_slope_plot
ggsave(
  paste0(folder_out,"usgs_huc2_states_2_sen_slope_plot_","site_type_",count_file,"_",sites_type,"_alpha_",alpha_value,".png"),
...
#usgs_huc2_states_3_norm_sen_slope_plot
ggsave(
  paste0(folder_out,"usgs_huc2_states_3_norm_sen_slope_plot_","site_type_",count_file,"_",sites_type,"_alpha_",alpha_value,".png"),
